...
# other ----
version = 2
welcome = paste0('Hi Virginia, welcome to the version number ',
                 version,
                 ' of the script on anhedonia. Each section of the script is currently structured to produce nested folders and sub-folders with all the relevant contents within it. I suggest you to change the working directory for the results to a local one, or you will constantly commit and push new reuslts.')
