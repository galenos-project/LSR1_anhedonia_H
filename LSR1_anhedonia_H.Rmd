...
For the primary outcome, anhedonia, two studies were rated high risk using the RoB2 tool, one due to domain three, bias due to missing outcome data, and one due to domain 5, the reporting of results.
Two further studies were rated 'some concerns' while another two were rated low.
These mixed risk of bias scores were....
...
descriptive_names <- c(age = "age", female_prop = "proportion of females",
...
sufficient_text <- if (length(sufficient_predictors) > 0) {
  paste("Sufficient data to conduct a meta-regression existed for", to_natural_list(sufficient_predictors))
} else {
  "sufficient data to conduct a meta-regression did not exist for any predictor."
}

insufficient_text <- if (length(insufficient_predictors) > 0) {
  paste("Insufficient data existed for", to_natural_list(insufficient_predictors))
} else {
  "insufficient data did not exist for any predictor."
}

# Combine the sentences
summary_available_data <- paste(sufficient_text, insufficient_text, sep = ". ")

#details of meta-regression for text

# Define acceptability as the outcome of interest 
...
for (predictor in predictors) {
  ...
  if (!is.null(regression_result) && !is.null(regression_result[["pval"]]) && length(regression_result[["pval"]]) >= 2) {
    if (regression_result[["pval"]][2] < 0.05) {
      ...
      message <- paste("The meta-regression for", descriptive_names[[predictor]], "was significant (beta =", beta, 
...
mr_significance_text_anhedonia <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_anhedonia`
...
```{r, anx_meta-reg, echo=F, include=T, results='asis'}

if (pwma.anxiety[["k"]] < 10) 
  
  cat(paste0('As there were less than 10 studies, no meta-regression was performed.'), sep = '\n')

```

```{r prepare-metareg-text-anx, echo=F}
# define predictors
predictors <- c("age", "female_prop", "anhedonia_baseline", "anxiety_baseline", "reward_baseline", "tx_duration")
...
# Combine all messages into a single string for inline use
mr_significance_text_anx <- paste(significance_summary, collapse = ". ")
```

In our analysis `r summary_available_data`.
`r mr_significance_text_anx`
...
```{r, acc_meta-reg, echo=F, include=T, results='asis'}
...
for (predictor in predictors) {
  ...
  if (!is.null(regression_result) && !is.null(regression_result[["pval"]]) && length(regression_result[["pval"]]) >= 2) {
    if (regression_result[["pval"]][2] < 0.05) {
      # Significant result, prepare text with the second values of beta and CI
      beta <- rounbd(regression_result[["beta"]][2], 3)
      ci_lb <- round(regression_result[["ci.lb"]][2], 3)
      ci_ub <- round(regression_result[["ci.ub"]][2], 3)
      message <- paste("The meta-regression for", descriptive_names[[predictor]], "was significant (beta =", beta, 
                        ", 95% CI from", ci_lb, "to", ci_ub, ")")
...
# Combine all messages into a single string for inline use
mr_significance_text_acc <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_acc`.
...
```{r, tol_meta-reg, echo=F, include=T, results='asis'}
...
# Combine all messages into a single string for inline use
mr_significance_text_tol <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_tol`.
...
```{r, nausea_meta-reg, echo=F, include=T, results='asis'}
...
# Combine all messages into a single string for inline use
mr_significance_text_nausea <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_nausea`.
...
```{r, headache_meta-reg, echo=F, include=T, results='asis'}
...
```{r metareg-text-headache, echo=F}
# define predictors
predictors <- c("age", "female_prop", "anhedonia_baseline", "anxiety_baseline", "reward_baseline", "tx_duration")
...
# Combine all messages into a single string for inline use
mr_significance_text_headache <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_headache`.
...
```{r, insomnia_meta-reg, echo=F, include=T, results='asis'}

if (pwma.insomnia[["k"]] < 10) 
  
  cat(paste0('As there were less than 10 studies, no meta-regression was performed.'), sep = '\n')

```

```{r metareg-text-insomnia, echo=F}
# define predictors
predictors <- c("age", "female_prop", "anhedonia_baseline", "anxiety_baseline", "reward_baseline", "tx_duration")
...
# Combine all messages into a single string for inline use
mr_significance_text_insomnia <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_insomnia`.
...
```{r, dry_mouth_meta-reg, echo=F, include=T, results='asis'}

if (pwma.dry_mouth[["k"]] < 10) 
  
  cat(paste0('As there were less than 10 studies, no meta-regression was performed.'), sep = '\n')

```

```{r metareg-text-dry_mouth, echo=F}
# define predictors
predictors <- c("age", "female_prop", "anhedonia_baseline", "anxiety_baseline", "reward_baseline", "tx_duration")
...
# Combine all messages into a single string for inline use
mr_significance_text_dry_mouth <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_dry_mouth`.
...
```{r, constipation_meta-reg, echo=F, include=T, results='asis'}

if (pwma.constipation[["k"]] < 10) 
  
  cat(paste0('As there were less than 10 studies, no meta-regression was performed.'), sep = '\n')

```

```{r metareg-text-constipation, echo=F}
# define predictors
predictors <- c("age", "female_prop", "anhedonia_baseline", "anxiety_baseline", "reward_baseline", "tx_duration")
...
# Combine all messages into a single string for inline use
mr_significance_text_constipation <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_constipation`.
...
```{r, dizziness_meta-reg, echo=F, include=T, results='asis'}
...
```{r metareg-text-dizziness, echo=F}
# define predictors
predictors <- c("age", "female_prop", "anhedonia_baseline", "anxiety_baseline", "reward_baseline", "tx_duration")
...
# Combine all messages into a single string for inline use
mr_significance_text_dizziness <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_dizziness`.
...
```{r, vomiting_meta-reg, echo=F, include=T, results='asis'}
...
```{r metareg-text-vomiting, echo=F}
# define predictors
predictors <- c("age", "female_prop", "anhedonia_baseline", "anxiety_baseline", "reward_baseline", "tx_duration")
...
# Combine all messages into a single string for inline use
mr_significance_text_vomiting <- paste(significance_summary, collapse = ". ")

```

In our analysis `r summary_available_data`.
`r mr_significance_text_vomiting`.
