...
2.  Eight databases were searched from inception up to the 4th of September, 2023 (see appendix for the full search strategies).
...
8.  We assessed risk of bias with the RoB2 tool (Sterne et al. 2019).
    All outcomes for all included studies were assessed as per [CITE] by at least two reviewers (JK, CF, CA, AH) and conflicts were resolved by discussion between reviewers.
...
![PRISMA Diagram](lsr1%20prisma.jpg)
...
```{r table_of_characteristics, echo=F, warning=F, include=T}
TOC_Indir <- read_xlsx("data/LSR1_H_TOC.xlsx", "all_studies")
table_output <- knitr::kable(TOC_Indir, na = "") %>%
...
```{r echo = F}
SoE_Indir <- read_xlsx("data/LSR1_H_SOE.xlsx", "SOE")
