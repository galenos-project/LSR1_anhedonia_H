...
```{r, echo=FALSE, include=FALSE}
##### FORMATTING NOTE if we want to list each predictor and give statistics (e.g. line 434), do we want both the model F and p values and the beta, 95%CI, and significance values of the coefficient, even if the coefficient wasn't a significant predictor??
