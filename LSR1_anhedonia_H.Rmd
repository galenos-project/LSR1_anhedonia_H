...
In comparison, we found effects across non-dopaminergic interventions to range from -0.09 (SMD, 95% CI from -0.78 to 0.60) in amitryptiline to -0.40 (SMD, 95% CI from -0.48 to -0.32) in duloxetine.
